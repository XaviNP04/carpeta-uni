...
poem_writer = Agent(
    ...
    backstory=(
        ...
        "Your style reminds the great poets of the eighteenth century."
    ),
    llm=llm,
    verbose=True
)
...
write_poem = Task(
    description=(
        "Write a poem with consonant rhyme in Spanish about how Computer Science is awesome. "
        "Ensure the poem is engaging and adheres to the specified sentence count of {sentence_count}."
        "Write each sentence in a different paragraph"
    ),
    expected_output=(
