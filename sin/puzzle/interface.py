...
class InterfaceApp:
    ...
    def __init__(self, master=None):
        ...
        self.algorithmbox.configure(cursor="hand2", state="readonly",
                                    values=('BFS', 'DFS (Graph Search)', 'DFS (Backtracking)', 'Voraz (Manhattan)', 'ID', 'A* Manhattan', 'A* Euclidean', 'IDA* Manhattan', 'A* Desc', 'A* Sec', 'A* FilCol', 'SeqDesc'))
        self.algorithmbox.place(anchor="center", height=40, width=150, x=700, y=230)
    ...
    def solveState():
        ...
        if str(algorithm) == 'BFS':
            ...
            path, cost, counter, depth, runtime, nodes, max_stored = \
                main.graphf_path, main.graphf_cost, main.graphf_counter, main.graphf_depth, main.time_graphf, main.node_counter, main.max_node_stored
       # ========================================= heuristiques implementades pract ============================================
        elif str(algorithm) == 'A* Desc':
            main.graphSearch(initialState, main.function_1, main.getDescDistance)
            path, cost, counter, depth, runtime, nodes, max_stored, memory_rep = \
                main.graphf_path, main.graphf_cost, main.graphf_counter, main.graphf_depth, main.time_graphf, main.node_counter, main.max_counter, main.max_rev_counter
        elif str(algorithm) == 'A* Sec':
            main.graphSearch(initialState, main.function_1, main.getSecDist)
            path, cost, counter, depth, runtime, nodes, max_stored, memory_rep = \
                main.graphf_path, main.graphf_cost, main.graphf_counter, main.graphf_depth, main.time_graphf, main.node_counter, main.max_counter, main.max_rev_counter
        elif str(algorithm) == 'A* FilCol':
            main.graphSearch(initialState, main.function_1, main.getFilColDist)
            path, cost, counter, depth, runtime, nodes, max_stored, memory_rep = \
                main.graphf_path, main.graphf_cost, main.graphf_counter, main.graphf_depth, main.time_graphf, main.node_counter, main.max_counter, main.max_rev_counter
        elif str(algorithm) == 'SeqDesc':
            main.graphSearch(initialState, main.function_1, main.getSeqDesc)
            path, cost, counter, depth, runtime, nodes, max_stored, memory_rep = \
                main.graphf_path, main.graphf_cost, main.graphf_counter, main.graphf_depth, main.time_graphf, main.node_counter, main.max_counter, main.max_rev_counter
